...
def protocol_status_lines() -> list[str]:
    return [
        ...
        "command_protocol: wheeltec_reference_source_confirmed_layout",
        "command_frame_layout: confirmed_against_wheeltec_reference_source",
        "motion_response: no_motion_observed_yet",
